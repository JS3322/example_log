  ...
  <Layout title="2020 서울대학교 모바일가상학교 통합관리시스템">
    <Container>
      ...
      <UnorderedList my={4}>
        ...
        <ListItem>
        통합관리 시스템 웹개발 PM 업무. 5억 연구비의 프로젝트에 통합관리 시스템 웹개발 파트 PM으로 참여. 제안서 PT작성 경험과 이모티콘, 시각디자인 작업. 앱서비스 병합 및 개발이력, 상태관리 운용하여 5개의 기업에 패키지 솔루션 납품 및 추천 시스템 기획, 개발하여 매출액 40% 증가 성과이력.
        </ListItem>

        <ListItem>
        React 비동기 로딩 관리 및 Embed구조와 배포 관리. React Suspense와 SWR 등 기능을 활용한 비동기 튜닝, Youtube를 포함한 Embed컴포넌트 기반으로 반응형과 크로스브라우징을 고려한 개발과 HTML, CSS, 데이터처리 컴포넌트화 설계 구현. 기존 웹앱을 PWA와 구글스토어에 개시하여 보수 경험.
        </ListItem>
