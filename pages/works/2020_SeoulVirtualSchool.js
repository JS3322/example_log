  ...
  <Layout title="2020 서울대학교 모바일가상학교 통합관리시스템">
    <Container>
      ...
      <UnorderedList my={4}>
        ...
        <ListItem>
        의료, VR, 모바일 통합관리 시스템 PM. 5억 연구비의 프로젝트에 통합관리 시스템 웹개발 파트 PM으로 참여. 제안서 PT작성 경험과 이모티콘, 시각디자인 작업. 앱서비스 병합 및 개발이력, 상태관리 운용하여 5개의 기업에 패키지 솔루션 납품 및 추천 시스템 기획, 개발하여 매출액 40% 증가 성과이력.
        </ListItem>
